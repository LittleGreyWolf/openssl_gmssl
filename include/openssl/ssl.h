...
//2022.02.19
//0-sccess, <0-error
typedef int (*gmSignCallback)(const char* addr, int port, char *dataBuf, int dataLen, char *signatureBuf, int *signatureLen);
void gmSetSignCallback(gmSignCallback impl);
